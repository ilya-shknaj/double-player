...
public class FileUtils {
	...
	private static final String IGNORE_EXTENSION = ".txt";
	...
	public static boolean isMediaUri(Uri uri) {
		...
		if (uriString.startsWith(Audio.Media.INTERNAL_CONTENT_URI.toString()) || uriString.startsWith(Audio.Media.EXTERNAL_CONTENT_URI.toString())
	...
	public static List<File> getFileList(String path) {
		...
		if (files != null) {
			...
			for (File file : files) {
				if (!getExtension(file.getName()).equals(IGNORE_EXTENSION)) {
					list.add(file);
				}
			}
		}
